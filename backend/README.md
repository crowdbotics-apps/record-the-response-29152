...
## Project Structure
    ...
    ├── record_the_response_29152  # Django project configurations
...
1. Clone this repo and `cd record_the_response_29152`
...
2. Clone this repo and `cd record_the_response_29152`
